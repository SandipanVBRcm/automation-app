...
export interface KnowledgeSource { source_number?: number; chunk_id: string; document_id: string; file_name: string; page_number?: number | null; section?: string | null; score: number }
...
export interface Health { status: string; mcp: string; providers: Record<Provider, boolean>; models: Record<Provider, string>; max_steps: number; idle_timeout: number; playwright_mcp_enabled: boolean; file_mcp_enabled: boolean }
